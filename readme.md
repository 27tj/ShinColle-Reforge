このmodは、PinkaLulan氏作のShinColleを許可を得てForge1.20.1に移植したものです。
Forge1.10.2で公開されていたものをそのまま移植しただけですので、現状新要素等はありません。
...
It is simply a direct port of the version released for Forge 1.10.2, so there are currently no new features.

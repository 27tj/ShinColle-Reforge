...
public class ModelDestroyerI extends ShipModelBaseAdv<Entity> {
    ...
    public ModelDestroyerI(ModelPart root) {
        ...
        // Main model hierarchy: root -> PBack -> {PNeck -> PHead -> PJawBottom, PBody -> {PLegLeft, PLegRight}, PTail -> ...}
        ...
        // Glow scaffolding hierarchy: root -> GlowPBack -> GlowPNeck -> GlowPHead -> {eyes, kisaragi}
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // EyeLightL[1,2] and EyeLightR[1,2] start hidden (set in constructor via setFace(0)).

        // Eye pair 0 - normal open eyes
        // Original: PEyeLightL[0] = new ModelRenderer(this, 138, 64); mirror=true; addBox(-3, 0, 15.1, 24, 20, 1)
        glowPHead.addOrReplaceChild("EyeLightL0",
                CubeListBuilder.create().mirror().texOffs(138, 64)
                        .addBox(-3F, 0F, 15.1F, 24, 20, 1),
                PartPose.ZERO);
        // Original: PEyeLightR[0] = new ModelRenderer(this, 138, 64); addBox(-3, 0, -16.1, 24, 20, 1)
        ...
        // Original: PEyeLightL[1] = new ModelRenderer(this, 138, 85); mirror=true; addBox(-3, 0, 15.1, 24, 20, 1)
        glowPHead.addOrReplaceChild("EyeLightL1",
                CubeListBuilder.create().mirror().texOffs(138, 85)
                        .addBox(-3F, 0F, 15.1F, 24, 20, 1),
                PartPose.ZERO);
        // Original: PEyeLightR[1] = new ModelRenderer(this, 138, 85); addBox(-3, 0, -16.1, 24, 20, 1)
        ...
        // Original: PEyeLightL[2] = new ModelRenderer(this, 138, 106); mirror=true; addBox(-3, 0, 15.1, 24, 20, 1)
        glowPHead.addOrReplaceChild("EyeLightL2",
                CubeListBuilder.create().mirror().texOffs(138, 106)
                        .addBox(-3F, 0F, 15.1F, 24, 20, 1),
                PartPose.ZERO);
        // Original: PEyeLightR[2] = new ModelRenderer(this, 138, 106); addBox(-3, 0, -16.1, 24, 20, 1)
        ...
        // Original: setRotationPoint(-7, -9, 14), texOffs(66, 102), addBox(0, 0, 0, 8, 8, 5)
        ...
        // Original: setRotationPoint(-7, -9, 14), texOffs(114, 102), addBox(-2, -16, 1, 8, 20, 3), rotation (0, 0, -0.524)
        ...
        // Original: setRotationPoint(-7, -9, 14), texOffs(92, 102), addBox(-7, -17, 0.8, 8, 18, 3), rotation (0, 0, -1.396)
        ...
        // Original: setRotationPoint(-7, -9, 14), texOffs(92, 102), addBox(-9, -18, 0.6, 8, 18, 3), rotation (0, 0, -2.094)

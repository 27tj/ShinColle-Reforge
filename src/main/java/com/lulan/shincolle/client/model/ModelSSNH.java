...
public class ModelSSNH extends ShipModelBaseAdv<Entity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(new ResourceLocation(Reference.MOD_ID, "ssnh"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition ring02 = ring01.addOrReplaceChild("Ring02",
                ...
                PartPose.offsetAndRotation(0.3F, 8.5F, 0.2F, 0.22759093446006054F, -0.03874630939427412F, -2.792526803190927F));

        PartDefinition ring03Base = ring02.addOrReplaceChild("Ring03Base",
                CubeListBuilder.create().texOffs(0, 0)
                .addBox(2.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F),
                PartPose.offsetAndRotation(-2.0F, -10.0F, 1.7F, -0.6108652381980153F, 0.17453292519943295F, -0.10471975511965977F));
    ...
    public void applyNormalPose(float f, float f1, float f2, float f3, float f4, IShipEmotion ent) {
		...
		// NOTE 1.20.1: offset not supported in new model API: this.EquipTBase_2.offsetX = 0F;
		// NOTE 1.20.1: offset not supported in new model API: this.EquipTBase_2.offsetY = 0F;
	    ...
	    if (ent.getIsSprinting() || f1 > 0.9F)
	    {
		    ...
		    this.LegLeft01.zRot = 0.05F;
		  	...
		  	if (showTorpedo)
		  	{
				...
				// NOTE 1.20.1: offset not supported in new model API: this.EquipTBase_2.offsetX = -0.17F;
				// NOTE 1.20.1: offset not supported in new model API: this.EquipTBase_2.offsetY = 0.64F;
		  	}
	    }
	    ...
	    {
	    	//player mount
	    	if (((net.minecraft.world.entity.Entity)ent).getVehicle() instanceof net.minecraft.world.entity.player.Player)
	    	{
	    		//body

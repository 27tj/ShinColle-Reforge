...
public class ModelBattleshipTa extends ShipModelBaseAdv<Entity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(new ResourceLocation(Reference.MOD_ID, "bb_ta"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        bodyMain.addOrReplaceChild("EquipLeft",
                ...
                PartPose.offsetAndRotation(9.0F, -13.0F, -6.0F, 0.0F, -0.13962634015954636F, 0.2617993877991494F));

        bodyMain.addOrReplaceChild("BoobR",
                CubeListBuilder.create().texOffs(0, 74)
                .addBox(-3.5F, 0.0F, 0.0F, 7.0F, 5.0F, 4.0F),
                PartPose.offsetAndRotation(-3.8F, -9.0F, -3.5F, -0.7853981633974483F, -0.17453292519943295F, -0.08726646259971647F));
        ...
        PartDefinition legRight = butt.addOrReplaceChild("LegRight",
                ...
                PartPose.offsetAndRotation(-4.5F, 9.5F, -3.0F, -0.2617993877991494F, 0.0F, -0.05235987755982988F));
        ...
        PartDefinition hairL01 = hair.addOrReplaceChild("HairL01",
                ...
                PartPose.offsetAndRotation(6.5F, 0.0F, -6.0F, -0.17453292519943295F, -0.17453292519943295F, -0.05235987755982988F));

        hairL01.addOrReplaceChild("HairL02",
                CubeListBuilder.create().texOffs(89, 103)
                .addBox(-1.0F, 0.0F, 0.0F, 2.0F, 9.0F, 2.0F),
                PartPose.offsetAndRotation(0.0F, 9.0F, 0.0F, 0.2617993877991494F, 0.0F, 0.05235987755982988F));

        PartDefinition hairR01 = hair.addOrReplaceChild("HairR01",
                CubeListBuilder.create().texOffs(88, 100)
                .addBox(-1.0F, 0.0F, 0.0F, 2.0F, 9.0F, 3.0F),
                PartPose.offsetAndRotation(-6.5F, 0.0F, -6.0F, -0.13962634015954636F, 0.17453292519943295F, 0.08726646259971647F));

        hairR01.addOrReplaceChild("HairR02",
                CubeListBuilder.create().texOffs(89, 103)
                .addBox(-1.0F, 0.0F, 0.0F, 2.0F, 9.0F, 2.0F),
                PartPose.offsetAndRotation(0.2F, 7.0F, 0.5F, 0.17453292519943295F, 0.0F, -0.05235987755982988F));

        hair.addOrReplaceChild("Ahoke",
                CubeListBuilder.create().texOffs(37, 101)
                .addBox(-4.5F, 0.0F, 0.0F, 10.0F, 10.0F, 0.0F),
                PartPose.offsetAndRotation(0.0F, -7.3F, -7.5F, -0.136659280431156F, -0.22759093446006054F, 0.0F));

        neckCloth.addOrReplaceChild("NeckTie",
                CubeListBuilder.create().texOffs(24, 97)
                .addBox(-3.0F, 0.0F, 0.0F, 6.0F, 7.0F, 0.0F),
                PartPose.offsetAndRotation(0.5F, 1.3F, -5.2F, -0.7F, 0.13962634015954636F, 0.13962634015954636F));
        ...
        bodyMain.addOrReplaceChild("EquipRight",
                ...
                PartPose.offsetAndRotation(-9.0F, -12.0F, -2.0F, 0.0F, 0.13962634015954636F, -0.17453292519943295F));

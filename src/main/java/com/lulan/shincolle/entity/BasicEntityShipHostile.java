...
public abstract class BasicEntityShipHostile extends Mob
	...
	protected void setAIList() {
		...
		this.goalSelector.addGoal(25,
				new net.minecraft.world.entity.ai.goal.LookAtPlayerGoal(this, Player.class, 8.0F));
		this.goalSelector.addGoal(26, new net.minecraft.world.entity.ai.goal.RandomLookAroundGoal(this));
	}
